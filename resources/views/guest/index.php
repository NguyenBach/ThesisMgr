        ...
        <div class="row clearfix browse">
            <div class="col-md-4 col">
                ...
                <div class="col-content">
                    ...
                    <ul class="donvi">
                        <li>
                            <a href="javascript:;" onclick="donviClick(this)" >Khoa Công nghệ thông tin</a>
                            <ul class="sub-donvi" style="display: none">
                                <li >
                                    <a href="javascript:;" onclick="donviClick(this)">Bộ môn</a>
                                    <ul style="display:none">
                                        <li><a href="#">Công nghệ phần mềm</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="javascript:;" onclick="donviClick(this)">Phòng thí nghiệm</a>
                                    <ul style="display:none">
                                        <li><a href="#">Phòng thí nghiệm tương tác người máy </a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">Văn Phòng Khoa</a>
                                </li>
                            </ul>
                        </li>
                        <li>
