...
<head>
    ...
    <meta name="teacherid" content="<?php echo session('userid') ?>" id="userid">
    ...
    <nav class="navbar navbar-inverse  clearfix">
        <div class="container">
            <ul class="nav navbar-nav">
                <li class="active"><a href="/lecturer">Home</a></li>
...
<!--                <label>Ngày nộp: </label> 20/11/2016 <br>-->
<!--                <label>Trạng thái: </label> <strong> Được chấp nhận</strong> <br>-->
            </div>
        </div>
