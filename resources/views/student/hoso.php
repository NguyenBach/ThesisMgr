    ...
    <nav class="navbar navbar-inverse  clearfix">
        <div class="container">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/student/file">Hồ sơ</a></li>
            </ul>
    ...
    <div class="row">
        <div class="col-md-9 dashboard">
            ...
            <div class="detaidk clearfix">
                ...
                <button class="btn btn-danger right" style="margin-left: 15px">Hủy đề tài</button>
                <button class="btn btn-danger right" >Sửa đề tài</button>
...
<script>showTeacherProfile();</script>
